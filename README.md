...
- 台灣新聞資料
    ...
    資料 | abstract | content  | content（挖掉過的） 
    ------|:-----:|------:|------:
    min | 11 | 186 | 150
    median| 159 | 721 | 548
    max | 2601 | 4997 | 4842
    mean| 172.49 | 941.66 | 769.18
    std | 72.02 | 681.11 | 674.66
    
- 紐約時報中文網（簡中翻譯繁中）（清理過後）1萬3

    資料 | title | summary | content
    ------|:-----:|------:|------:
    min | 4 | 14 | 100
    median| 16 | 75 | 2180
    max | 35 | 156 | 38882
    mean| 15.96 | 72.31 | 2370.08
    std | 4 | 7.71| 1548
...
- 紐約時報中文網（簡中翻譯繁中）（清理過後）3萬
    ...
    median| 15 | 72 | 1979
    max | 35 | 156 | 38882
    mean| 15.38 | 70.52 | 2181.93
    std | 3.65 | 8.72 | 1444.29
